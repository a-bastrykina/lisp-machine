...
public class DoTimes implements Expression {
	...
	public Expression evaluate(ExecutionContext context) {
		...
		for (int i = 0; i < (int) upperLimit.getValue(); i++) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(variable, doTimes.variable) && Objects.equals(upperLimit, doTimes.upperLimit) && Objects
				.equals(body, doTimes.body);
	}
